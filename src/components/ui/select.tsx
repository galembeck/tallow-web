      ...
      >
        ...
        <SelectPrimitive.Viewport
          className={cn(
            "p-1",
            position === "popper" &&
              "h-[var(--radix-select-trigger-height)] w-full min-w-[var(--radix-select-trigger-width)] cursor-pointer scroll-my-1",
          )}
        >
          {children}
        </SelectPrimitive.Viewport>
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      className={cn(
        "flex cursor-default cursor-pointer items-center justify-center py-1",
        className,
      )}
