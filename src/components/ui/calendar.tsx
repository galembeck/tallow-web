/** biome-ignore-all lint/correctness/noNestedComponentDefinitions: required by @DateFNS */
    ...
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          ...
          "size-(--cell-size) cursor-pointer select-none p-0 aria-disabled:opacity-50",
